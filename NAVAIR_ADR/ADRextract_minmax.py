...
# Setup store
store = pd.HDFStore('bin/flightstore1.h5')
...
min_vars = variables.index[(variables['process'] =='y') & (variables['min'].notna())].tolist()
max_vars = variables.index[(variables['process'] =='y') & (variables['max'].notna())].tolist()

min_var_values = variables['min']
min_var_values = [variables[var] for var in max_vars]

print(min_vars,min_var_values)
